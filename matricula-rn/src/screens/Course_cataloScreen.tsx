...
import { listCourseCatalogsApi, createServiceTypeApi, deleteServiceTypeApi } from "../api/course_catalo.api";
...
export default function Course_cataloScreen() {
  ...
  const load = async (): Promise<void> => {
    try {
      setErrorMessage("");
      const data = await listCourse_cataloApi();

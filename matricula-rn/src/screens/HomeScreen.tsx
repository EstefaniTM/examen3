...
export default function HomeScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Pressable onPress={() => navigation.navigate("Course_catalo")} style={styles.btn}>
        <Text style={styles.btnText}>Course_catalo (list/create/delete)</Text>
      </Pressable>

      <Pressable onPress={() => navigation.navigate("VehicleServices")} style={styles.btn}>
        <Text style={styles.btnText}>Enrollment_events (2 selects + create/delete)</Text>
      </Pressable>
